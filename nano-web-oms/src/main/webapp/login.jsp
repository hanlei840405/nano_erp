...
<script type="text/javascript" charset="UTF-8" src="resources/login/js/prefixfree.min.js"></script>
<style type="text/css">
body {
	background: url(resources/login/img/bg.png);
...
.login-form:before {
	...
	background: #fff url("resources/login/img/profilepicture.jpg") no-repeat 2px 2px;
}
...
@font-face {
	font-family: 'loginform-icon';
	src: url("resources/login/font/loginform-icon.eot");
	src: url("resources/login/font/loginform-icon.eot?#iefix") format('embedded-opentype'),
		url("resources/login/font/loginform-icon.woff") format('woff'),
		url("resources/login/font/loginform-icon.ttf") format('truetype'),
		url("resources/login/font/loginform-icon.svg#loginform-icon") format('svg');
	font-weight: normal;
	font-style: normal;
}
</style>
		...
		<form method="post" class="login-form">
			<div class="username">
				<input type="text" name="username"
					placeholder="admin" autocomplete="on" /> <span
					class="user-icon icon">u</span>
			</div>
			<div class="password">
				<input type="password" name="password" placeholder="admin" /> <span
