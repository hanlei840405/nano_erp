<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="base_mark_layout" class="easyui-layout"
	style="height: auto; width: 100%" fit="true">
	<div data-options="region:'center',border:false">
		<table id="base_mark_mark_datagrid">
		</table>
	</div>
</div>
<div id="base_mark_saveOrUpdate_window" class="easyui-window"
	...
	<div class="easyui-layout" style="height: 250px;" fit="true">
		<div data-options="region:'center'" style="min-height: 50px">
			<form id="base_mark_edit_form" action="base/mark/save"
				method="post">
				...
				<table cellpadding="5">
					<tr>
						<td>内容:</td>
						<td><input name="content" id="base_mark_content"
		...
		<div data-options="region:'south'"
			...
			<a href="javascript:void(0)" class="easyui-linkbutton"
				onclick="baseMarkSubmitForm()">提交</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
				onclick="clearForm('base_mark_edit_form')">重置</a>
		</div>
	</div>
</div>
<script>
